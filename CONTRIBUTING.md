...
https://metacpan.org/release/Dist-Zilla-Plugin-Test-TidyAll

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::Plugin::Test::TidyAll
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::Plugin::Test::TidyAll
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/Dist-Zilla-Plugin-Test-TidyAll).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Dist-Zilla-Plugin-Test-TidyAll)
or [via email](bug-dist-zilla-plugin-test-tidyall@rt.cpan.org.
